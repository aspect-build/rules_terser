...
load("@npm__acorn__8.8.0__links//:defs.bzl", store_0 = "npm_imported_package_store")
load("@npm__buffer-from__1.1.2__links//:defs.bzl", store_1 = "npm_imported_package_store")
load("@npm__commander__2.20.3__links//:defs.bzl", store_2 = "npm_imported_package_store")
load("@npm__lodash.sortby__4.7.0__links//:defs.bzl", store_3 = "npm_imported_package_store")
load("@npm__punycode__2.1.1__links//:defs.bzl", store_4 = "npm_imported_package_store")
load("@npm__source-map-support__0.5.21__links//:defs.bzl", store_5 = "npm_imported_package_store")
load("@npm__source-map__0.6.1__links//:defs.bzl", store_6 = "npm_imported_package_store")
load("@npm__source-map__0.8.0-beta.0__links//:defs.bzl", store_7 = "npm_imported_package_store")
load("@npm__terser__5.13.0__links//:defs.bzl", link_8 = "npm_link_imported_package_store", store_8 = "npm_imported_package_store")
load("@npm__tr46__1.0.1__links//:defs.bzl", store_9 = "npm_imported_package_store")
load("@npm__webidl-conversions__4.0.2__links//:defs.bzl", store_10 = "npm_imported_package_store")
load("@npm__whatwg-url__7.1.0__links//:defs.bzl", store_11 = "npm_imported_package_store")
