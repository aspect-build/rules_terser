...
load("@npm_aspect_rules_terser__at_jridgewell_gen-mapping__0.3.2__links//:defs.bzl", store_0 = "npm_imported_package_store")
load("@npm_aspect_rules_terser__at_jridgewell_resolve-uri__3.1.0__links//:defs.bzl", store_1 = "npm_imported_package_store")
...
load("@npm_aspect_rules_terser__source-map-support__0.5.21__links//:defs.bzl", store_9 = "npm_imported_package_store")
load("@npm_aspect_rules_terser__source-map__0.6.1__links//:defs.bzl", store_10 = "npm_imported_package_store")
load("@npm_aspect_rules_terser__terser__5.14.0__links//:defs.bzl", link_11 = "npm_link_imported_package_store", store_11 = "npm_imported_package_store")
